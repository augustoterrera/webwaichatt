...
export default function BlogPostPage({ blog, recommendedBlogs }: slugPage) {
                    ...
                    <section className="relative bg-gradient-to-br from-[#1F6B49] via-[#268656] to-[#2D9F6F] pt-8 pb-0">
                        <div className="max-w-6xl mx-auto px-6">
                            <div className="max-w-4xl mb-12">
                                <Badge className="mb-4 bg-white/20 text-white border-white/30 hover:bg-white/30 md: mt-10">
                                    Artículo
                                </Badge>
                                ...
                                <div className="flex items-center gap-2 text-white/80">
                                    ...
                                    <time className="text-base">
                                        {new Date(blog.created_at).toLocaleDateString("es-AR", { dateStyle: "long" })}
                                    </time>
                                </div>
                            </div>
                            ...
                            <div className="max-w-6xl mx-auto">
                                <div className="mb-12">
                                    ...
                                    <p className="text-lg text-muted-foreground">
                                        Continúa aprendiendo con estos artículos recomendados
                                    </p>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                    {recommendedBlogs.map((recBlog: any) => (
                                            ...
                                            <Card className="h-full hover:shadow-xl transition-all duration-300 rounded-2xl overflow-hidden group border-0 shadow-md">
                                                ...
                                                <CardContent className="p-6">
                                                    ...
                                                    <div className="flex items-center gap-2 text-sm text-muted-foreground mb-4">
                                                        ...
                                                        <time>
                                                            {new Date(recBlog.created_at).toLocaleDateString("es-AR", { dateStyle: "medium" })}
                                                        </time>
                                                    </div>
